...
class ApiExceptionTest {
    ...
    static Stream<Class<? extends ApiException>> exceptionProvider() {
        return Stream.of(
                ApiException.class,
    ...
    void givenMessage_whenCreatingException_thenMessageIsSet(Class<? extends ApiException> exceptionClass)
            throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        // Given - a test message to initialize the exception
        String message = TEST_MESSAGE;

        // When - creating an instance of ApiException with the test message
        ApiException exception = exceptionClass.getConstructor(String.class).newInstance(message);
    ...
    @ParameterizedTest
    @MethodSource("exceptionProvider")
    void givenCause_whenCreatingException_thenCauseIsSet(Class<? extends ApiException> exceptionClass)
            throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        // Given - a test cause to initialize the exception
        Throwable cause = TEST_CAUSE;

        // When - creating an instance of ApiException with the test cause
        ApiException exception = exceptionClass.getConstructor(Throwable.class).newInstance(cause);
    ...
    void givenMessageAndCause_whenCreatingException_thenMessageAndCauseAreSet(
        ...
        // When - creating an instance of ApiException with the test message and cause
        ApiException exception = exceptionClass.getConstructor(String.class, Throwable.class)
    ...
    void givenException_whenCallingToString_thenReturnsExpectedString(
        ...
        // When - creating an instance of ApiException with the test message
        ApiException exception = exceptionClass.getConstructor(String.class)
                .newInstance(message);
